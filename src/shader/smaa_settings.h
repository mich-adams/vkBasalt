...
layout(constant_id = 7) const int   maxSearchSteps = 32;
layout(constant_id = 8) const int   maxSearchStepsDiag = 16;
layout(constant_id = 9) const int   cornerRounding = 25;
layout(constant_id = 10) const int  debugView = 0;

// Depth settings
layout(constant_id = 11) const int      depthInputIsUpsideDown = 0;
layout(constant_id = 12) const int      depthInputIsReverse = 0;
layout(constant_id = 13) const int      depthInputIsLogarithmic = 0;
layout(constant_id = 14) const float    depthMultiplier = 1.0;
layout(constant_id = 15) const float    depthLinearizationFarPlane = 1000.0;
